...
// references: 
// 1. https://github.com/geefr/WebGL-Ray-Tracing/blob/main/shaders/raytrace_quad.frag (this file & primitive structure)
// 2. https://github.com/kamyy/webgl-ray-tracer/blob/master/public/sample-fs.glsl
// 3. https://github.com/a-churchill/webgl-path-tracing/blob/main/shaders/fragment-shader.glsl
